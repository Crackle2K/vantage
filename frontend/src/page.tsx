/**
 * @fileoverview Landing page (route `/`). Renders a hero animation, feature
 * showcase, social proof section, testimonial carousel, and newsletter signup.
 */
...
/**
 * Home page component. Combines HeroTransition, FeatureShowcase,
 * an Instagram-style image grid, a testimonial carousel with
 * navigation, and a newsletter email subscription form.
 *
...
export default function HomePage() {
  ...
  return (
    <div className="overflow-x-clip">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-surface dark:bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-heading md:text-display font-bold text-center mb-4 font-heading text-[hsl(var(--foreground))]">
            Connect with us!<br />
          </h2>
          <p className="text-center text-body text-[hsl(var(--muted-foreground))] mb-8 sm:mb-12">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-surface-elevated dark:bg-surface/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <h2 className="text-heading md:text-display font-bold text-center mb-10 sm:mb-14 md:mb-16 font-heading text-[hsl(var(--foreground))]">
            Our Reviews!
          </h2>

          <div className="rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 sm:p-8 md:p-12 lg:p-16 shadow-lg">
            <div className="text-[hsl(var(--foreground))]">
              <p className="text-base sm:text-subheading md:text-heading font-serif italic mb-6 sm:mb-8 leading-relaxed">
                "{testimonials[testimonialIndex].quote}"
              </p>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm sm:text-subheading font-bold mb-1">{testimonials[testimonialIndex].name}</p>
      ...
      <section className="py-14 sm:py-16 md:py-20 bg-[hsl(var(--card))] border-t border-[hsl(var(--border))]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md sm:max-w-lg mx-auto">
