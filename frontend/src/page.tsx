...
const heroImageUrl = 'https://picsum.photos/seed/vantage-dark-cafe/1920/1280';
    ...
    <main className="min-landing" ref={landingRootRef}>
      ...
      <section className="min-hero min-hero--image" ref={heroSectionRef}>
        <div className="min-hero-shell">
          <div className="min-hero-visual min-reveal" ref={heroFrameRef} aria-label="Dark cafe interior">
            <img
              ref={heroImageRef}
              className="min-hero-visual__image"
              src={heroImageUrl}
              alt="Dark cafe interior with low warm light and quiet tables."
            />
      ...
      <section className="min-section min-section--tight" id="signals">
        <div className="min-container">
          <div className="min-section__header min-reveal">
            <p className="min-kicker">The ranking model</p>
            <h2>Discovery should answer what changed recently.</h2>
            <p>
          ...
          <div className="min-bento">
            {signalCards.map((card) => (
              <article key={card.title} className="min-bento__card min-reveal">
                <span className="min-mono">{card.meta}</span>
                <h3>{card.title}</h3>
                <p>{card.detail}</p>
              </article>
            ))}
          ...
          <div className="min-category-grid">
            {categoryCards.map((category) => (
              <Link
                ...
                to="/businesses"
                className="min-category-card min-reveal"
            ...
            >
              <article className="min-panel-card min-panel-card--stack min-panel-card--locals">
                <div className="min-panel-block">
                  ...
                  <h3>Save the places you would actually recommend.</h3>
                  <p>
                ...
                <div className="min-panel-ledger">
                  {localSignalRows.map((row) => (
                    <div className="min-panel-ledger__row" key={row.label}>
                      <span>{row.label}</span>
