...
export function HeroTransition() {
	...
	// ── Refs ──────────────────────────────────────────────────────────────────
	const outerRef = useRef<HTMLDivElement>(null) // 320vh scroll container
	...
	// ── Desktop render ────────────────────────────────────────────────────────
	return (
		// Outer: 320vh provides the scroll distance for the pinned animation (extended for longer hero)
		// Negative margin removes the layout's pt-24 padding so hero starts at viewport top
		<div ref={outerRef} style={{ height: "320vh", position: "relative", marginTop: "-96px" }}>

			{/* Sticky viewport — stays fixed in place for all 320vh of scroll */}
			<div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden" }}>
				...
				>
					<div className="w-full max-w-5xl px-8 grid grid-cols-3 gap-6 items-end">
						...
						<div
							ref={centerCardRef}
							className="relative rounded-[22px] aspect-4/5 min-h-80 bg-[hsl(var(--card))]"
